namespace SuperBot.WebApi.DTOs
{
    public class AccountOverviewDto
    {
        ...
        public IReadOnlyList<AccountOrderDto> RecentOrders { get; set; }
        public IReadOnlyList<AccountKeyDto> RecentKeys { get; set; }
        public IReadOnlyList<AccountRecommendationDto> Recommendations { get; set; }
    }
