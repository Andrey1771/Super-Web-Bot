    ...
    return (
        <div className="space-y-7">
            ...
            >
                ...
                <div className="mt-4 grid gap-3 lg:grid-cols-[1.8fr_1fr] lg:items-center">
                    <div
                        className="relative"
                        ...
                        >
                            {testimonialItems.map((review, index) => (
                                <article
                                    ...
                                    className="min-w-[82%] snap-start rounded-[14px] border border-[#ece4ff] bg-[#fcfbff] p-3 shadow-[0_8px_18px_rgba(108,85,164,0.08)] sm:min-w-[46%] lg:min-w-[40%]"
                                >
            ...
            >
                ...
                <div className="relative z-10 grid gap-4 lg:grid-cols-[1.7fr_auto] lg:items-end">
                    <div>
                    ...
                    <div className="flex flex-wrap gap-3 lg:justify-end">
                        <button
                            type="button"
                            className="rounded-[12px] bg-[#6b3ff2] px-6 py-2.5 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(107,63,242,0.28)] transition hover:brightness-110"
                        ...
                        <button
                            type="button"
                            className="rounded-[12px] border border-[#d6c8ff] bg-white px-6 py-2.5 text-sm font-semibold text-[#46377f] transition hover:bg-[#faf8ff]"
