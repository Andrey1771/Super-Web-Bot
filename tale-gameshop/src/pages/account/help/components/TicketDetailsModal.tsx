...
import {closeTicket, downloadTranscript, getTicketDetails, postTicketMessage, resolveTicket, uploadTicketAttachment} from '../../../../api/supportApi';
...
const TicketDetailsModal: React.FC<TicketDetailsModalProps> = ({isOpen, onClose, ticketId, initialTicket}) => {
    ...
    const handleDownload = async () => {
        ...
        try {
            const blob = await downloadTranscript(ticketId);
            const url = window.URL.createObjectURL(blob);
            const link = document.createElement('a');
            link.href = url;
            link.download = `ticket-${ticketId}-transcript.pdf`;
            link.click();
            ...
            >
                <div className="ticket-modal__header">
                    <div>
                        ...
                        {ticket && (
                            <p className="ticket-modal__subtitle">
                    ...
                    <div className="ticket-modal__left">
                        ...
                        <div className="ticket-modal__composer">
                            ...
                            <div className="ticket-modal__tips">
                                ...
                                <span>Estimated response time: 2–6 hours.</span>
                            </div>
                        </div>
                    </div>
